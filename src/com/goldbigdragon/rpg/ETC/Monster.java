...
import com.goldbigdragon.rpg.custom.AI_Animal;
import com.goldbigdragon.rpg.custom.AI_CombatMonster;
import com.goldbigdragon.rpg.custom.AI_Elite_Hunter;
import com.goldbigdragon.rpg.custom.AI_Hunter;
import com.goldbigdragon.rpg.custom.AI_KamiKaze;
import com.goldbigdragon.rpg.custom.AI_NoBrain;
import com.goldbigdragon.rpg.custom.AI_Spector;
import com.goldbigdragon.rpg.custom.NMSUtils;
...
public class Monster
{
	...
	public void InventorySetting(InventoryCloseEvent event)
	{
		...
		if(event.getInventory().getItem(0)==new com.goldbigdragon.rpg.gui.GUIutil().getItemStack(ChatColor.WHITE + "머리", 302,0,1,Arrays.asList(ChatColor.GRAY + "이곳에 아이템을 넣어 주세요.")))
			Monster.set(MonsterName+".Head.Item", null);
		else
			Monster.set(MonsterName+".Head.Item", event.getInventory().getItem(0));
		
		if(event.getInventory().getItem(1)==new com.goldbigdragon.rpg.gui.GUIutil().getItemStack(ChatColor.WHITE + "갑옷", 303,0,1,Arrays.asList(ChatColor.GRAY + "이곳에 아이템을 넣어 주세요.")))
					Monster.set(MonsterName+".Chest.Item", null);
		else
			Monster.set(MonsterName+".Chest.Item", event.getInventory().getItem(1));
		if(event.getInventory().getItem(2)==new com.goldbigdragon.rpg.gui.GUIutil().getItemStack(ChatColor.WHITE + "바지", 304,0,1,Arrays.asList(ChatColor.GRAY + "이곳에 아이템을 넣어 주세요.")))
			Monster.set(MonsterName+".Leggings.Item", null);
		else
			Monster.set(MonsterName+".Leggings.Item", event.getInventory().getItem(2));
		if(event.getInventory().getItem(1)==new com.goldbigdragon.rpg.gui.GUIutil().getItemStack(ChatColor.WHITE + "부츠", 305,0,1,Arrays.asList(ChatColor.GRAY + "이곳에 아이템을 넣어 주세요.")))
			Monster.set(MonsterName+".Boots.Item", null);
		else
			Monster.set(MonsterName+".Boots.Item", event.getInventory().getItem(3));
		if(event.getInventory().getItem(4)==new com.goldbigdragon.rpg.gui.GUIutil().getItemStack(ChatColor.WHITE + "무기", 267,0,1,Arrays.asList(ChatColor.GRAY + "이곳에 아이템을 넣어 주세요.")))
