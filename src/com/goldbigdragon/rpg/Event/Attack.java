...
public class Attack
{
	public boolean AttackAble(Player player)
	{
        ...
        {
        	long time = new com.goldbigdragon.rpg.util.ETC().getSec();
	...
	{
		int a = new com.goldbigdragon.rpg.util.Number().RandomNum(1, 5);
		new com.goldbigdragon.rpg.effect.Sound().SL(defenser.getLocation(), Sound.ZOMBIE_METAL, (float)1.0, (float)0.7);
	    PacketSender t = new PacketSender();
