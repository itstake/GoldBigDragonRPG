...
import com.goldbigdragon.rpg.PartyDataObject;
	...
	public void onCommand(CommandSender talker, Command command, String string, String[] args)
    {
	    com.goldbigdragon.rpg.effect.Sound s = new com.goldbigdragon.rpg.effect.Sound();
			...
			if(args.length == 0)
			{
				...
				new com.goldbigdragon.rpg.gui.PartyGUI().PartyGUI_Main(player); return;
			}
			if(args.length <= 1)
			{
				switch(args[0])
				{
					case "목록":
						{
						 	s.SP((Player)talker, org.bukkit.Sound.HORSE_ARMOR, 0.8F, 1.8F);
						 	new com.goldbigdragon.rpg.gui.PartyGUI().PartyListGUI(player, 0);
						}
						return;
					case "탈퇴":
						{
