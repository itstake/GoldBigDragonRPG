...
public class ItemsCommand extends HelpMessage
{
	public void onCommand1(CommandSender talker, Command command, String string, String[] args)
	{
		Player player = (Player) talker;
		  ...
		  else
		  {
			  ...
			  new com.goldbigdragon.rpg.effect.Sound().SP((Player)talker, org.bukkit.Sound.ORB_PICKUP, 2.0F, 1.7F);
			  return;
		  }
	}
	...
	{
		com.goldbigdragon.rpg.etc.Items I = new com.goldbigdragon.rpg.etc.Items();
		Player player = (Player) talker;
		if(talker.isOp() == true)
		{
			String s="";
